...
void LoadingScene::Init()
{
	...
	AddLoadFunc([]() {IMAGEMANAGER->LoadFromFile(L"Plant8", Resources(L"/05_Object/Plant8.png"), 2, 1); });
	AddLoadFunc([]() {IMAGEMANAGER->LoadFromFile(L"Plant8-2", Resources(L"/05_Object/Plant8-2.png"), 2, 1); });
	...
	AddLoadFunc([]() {IMAGEMANAGER->LoadFromFile(L"Tree", Resources(L"/05_Object/Tree.png"), 2, 1); });
	AddLoadFunc([]() {IMAGEMANAGER->LoadFromFile(L"Tree2", Resources(L"/05_Object/Tree2.png"), 2, 1); });
	AddLoadFunc([]() {IMAGEMANAGER->LoadFromFile(L"Tree3", Resources(L"/05_Object/Tree3.png"), 2, 1); });
	AddLoadFunc([]() {IMAGEMANAGER->LoadFromFile(L"Tree4", Resources(L"/05_Object/Tree4.png"), 2, 1); });
	AddLoadFunc([]() {IMAGEMANAGER->LoadFromFile(L"Tree5", Resources(L"/05_Object/Tree5.png"), 2, 1); });
	AddLoadFunc([]() {IMAGEMANAGER->LoadFromFile(L"Tree6", Resources(L"/05_Object/Tree6.png"), 2, 1); });
	AddLoadFunc([]() {IMAGEMANAGER->LoadFromFile(L"Tree7", Resources(L"/05_Object/Tree7.png"), 2, 1); });
	AddLoadFunc([]() {IMAGEMANAGER->LoadFromFile(L"Tree8", Resources(L"/05_Object/Tree8.png"), 2, 1); });
