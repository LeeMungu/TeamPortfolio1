...
void LoadingScene::Init()
{
	...
	AddLoadFunc([]() {IMAGEMANAGER->LoadFromFile(L"Door2", Resources(L"/05_Object/Door2.png"), 2, 1); });
	AddLoadFunc([]() {IMAGEMANAGER->LoadFromFile(L"Door3", Resources(L"/05_Object/Door3.png"), 2, 1); });
	AddLoadFunc([]() {IMAGEMANAGER->LoadFromFile(L"Door4", Resources(L"/05_Object/Door4.png"), 2, 1); });
