...
void WorkTable::Init()
{
	...
	mMakeWoodBoard = new Button(L"나무판", mX + 230, mY + 120, 80, 50, [this]() {mBtnKey = "WoodBoard"; mMakingTotalCount = 0; mMakingCount = 0; DeleteItem(); Worktemplet(mBtnKey); });
	//vmMakeBonFire = new Button(L"모닥불", mX + 230, mY + 140, 80, 50, [this]() {mBtnKey = "BonFire", Worktemplet(mBtnKey); });
	mMakeBarrigate = new Button(L"바리게이트", mX + 230, mY + 160, 80, 50, [this]() {mBtnKey = "Barrigate"; mMakingTotalCount = 0;  mMakingCount = 0; DeleteItem(); Worktemplet(mBtnKey); });
	mMakeBoom = new Button(L"폭탄", mX + 230, mY + 200, 80, 50, [this]() {mBtnKey = "Boom"; mMakingTotalCount = 0; mMakingCount = 0; DeleteItem(); Worktemplet(mBtnKey); });
